            ...
            <ImageBackground source={require("../../assets/background.png")} style={{ flex: 1 }} resizeMode="cover">
                <ScrollView>
                    <View style={{ marginTop: 90 }}>
                        <Text style={{ textAlign: "center", color: "white", fontSize: 40, fontWeight: "bold" }}>Welcome</Text>
                        <Text style={{ textAlign: "center", color: "white", fontSize: 20, fontWeight: "bold" }}>Sign Up</Text>
                    </View>
                    <View style={{ marginTop:60 }}>
                        <TextInput placeholder="Username" onChangeText={(text) => onChangeHandler('username', text)} placeholderTextColor={"white"} style={{ color: "white", borderBottomWidth: 1, borderBottomColor: "white", fontSize: 20, fontWeight: "bold", marginHorizontal: 15, paddingVertical: 15 }} />
                        <TextInput placeholder="Email" onChangeText={(text) => onChangeHandler('email', text)} placeholderTextColor={"white"} style={{ color: "white", borderBottomWidth: 1, borderBottomColor: "white", fontSize: 20, fontWeight: "bold", marginHorizontal: 15, paddingVertical: 15, marginTop: 30 }} />
                    ...
                    <View style={{ marginTop: 70 }}>
                        <TouchableHighlight style={{ paddingVertical: 15, marginHorizontal: 20, backgroundColor: "#930038", borderRadius: 10 }}>
                            <Text style={{ color: "white", textAlign: "center", fontSize: 25, fontWeight: "bold" }}>Create an Account</Text>
                        </TouchableHighlight>
                    ...
                    <View>
                        <TouchableHighlight onPress={()=>props.navigation.navigate("signin")} style={{ paddingVertical: 15, paddingHorizontal: 20, marginHorizontal: 25,marginTop:50, borderRadius: 10 ,marginBottom:20}}>
